...
export const GameOverModal = withOverlay(({ onConfirm, onCancel }) => {
  return (
    <div className="transition-opacity inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all p-6 sm:align-middle w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
      ...
      <div className="flex justify-end">
        <Button onClick={onCancel} label='Ok' className='mr-4' />
