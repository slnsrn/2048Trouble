...
export default function Title ({ title }) {
  ...
  return (
    <div className="cursor-pointer relative text-center text-6xl lg:text-[80px]"
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full text-indigo-400" style={maskStyle}>
        <h1>{title}</h1>
      </div>
    </div >
  )
