    ...
    9688: (e, r, o) => {
      ...
      let ed = (function (e, ...r) {
        ...
        let e = w('color'),
          ...
          C = () => [X, D, i],
          N = () => [P, 'full', 'auto', ...C()],
          E = () => [G, 'none', 'subgrid', X, D],
          M = () => ['auto', { span: ['full', G, X, D] }, G, X, D],
          _ = () => [G, 'auto', X, D],
          W = () => ['auto', 'min', 'max', 'fr', X, D],
          A = () => [
            'start',
            'end',
            'center',
          ...
          eo = () => [e, X, D],
          et = () => [...y(), J, B, { position: [X, D] }],
          en = () => [
            'no-repeat',
            { repeat: ['', 'x', 'y', 'space', 'round'] },
          ],
          ea = () => ['auto', 'cover', 'contain', K, T, { size: [X, D] }],
          el = () => [I, Z, q],
          es = () => ['', 'none', 'full', d, X, D],
          ei = () => ['', $, Z, q],
        ...
        return {
          ...
          classGroups: {
            aspect: [{ aspect: ['auto', 'square', P, D, X, g] }],
            container: ['container'],
            columns: [{ columns: [$, D, X, s] }],
            ...
            z: [{ z: [G, 'auto', X, D] }],
            basis: [{ basis: [P, 'full', 'auto', s, ...C()] }],
            'flex-direction': [
              { flex: ['row', 'row-reverse', 'col', 'col-reverse'] },
            ],
            'flex-wrap': [{ flex: ['nowrap', 'wrap', 'wrap-reverse'] }],
            flex: [{ flex: [$, P, 'auto', 'initial', 'none', D] }],
            grow: [{ grow: ['', $, X, D] }],
            shrink: [{ shrink: ['', $, X, D] }],
            order: [{ order: [G, 'first', 'last', 'none', X, D] }],
            ...
            'font-size': [{ text: ['base', o, Z, q] }],
            'font-smoothing': ['antialiased', 'subpixel-antialiased'],
            'font-style': ['italic', 'not-italic'],
            'font-weight': [{ font: [t, X, F] }],
            'font-stretch': [
              {
                'font-stretch': [
                  'ultra-condensed',
            ...
            tracking: [{ tracking: [n, X, D] }],
            'line-clamp': [{ 'line-clamp': [$, 'none', X, F] }],
            leading: [{ leading: [a, ...C()] }],
            'list-image': [{ 'list-image': ['none', X, D] }],
            'list-style-position': [{ list: ['inside', 'outside'] }],
            'list-style-type': [{ list: ['disc', 'decimal', 'none', X, D] }],
            'text-alignment': [
            ...
            'text-decoration-thickness': [
              { decoration: [$, 'from-font', 'auto', X, q] },
            ],
            'text-decoration-color': [{ decoration: eo() }],
            'underline-offset': [{ 'underline-offset': [$, 'auto', X, D] }],
            'text-transform': [
              'uppercase',
              'lowercase',
              'capitalize',
            ...
            'outline-offset': [{ 'outline-offset': [$, X, D] }],
            'outline-w': [{ outline: ['', $, Z, q] }],
            ...
            'mask-image-radial': [{ 'mask-radial': [X, D] }],
            ...
            'mask-image': [{ mask: ['none', X, D] }],
            filter: [{ filter: ['', 'none', X, D] }],
            blur: [{ blur: ep() }],
            brightness: [{ brightness: [$, X, D] }],
            contrast: [{ contrast: [$, X, D] }],
            'drop-shadow': [{ 'drop-shadow': ['', 'none', u, Y, Q] }],
            'drop-shadow-color': [{ 'drop-shadow': eo() }],
            grayscale: [{ grayscale: ['', $, X, D] }],
            'hue-rotate': [{ 'hue-rotate': [$, X, D] }],
            invert: [{ invert: ['', $, X, D] }],
            saturate: [{ saturate: [$, X, D] }],
            sepia: [{ sepia: ['', $, X, D] }],
            'backdrop-filter': [{ 'backdrop-filter': ['', 'none', X, D] }],
            'backdrop-blur': [{ 'backdrop-blur': ep() }],
            'backdrop-brightness': [{ 'backdrop-brightness': [$, X, D] }],
            'backdrop-contrast': [{ 'backdrop-contrast': [$, X, D] }],
            'backdrop-grayscale': [{ 'backdrop-grayscale': ['', $, X, D] }],
            'backdrop-hue-rotate': [{ 'backdrop-hue-rotate': [$, X, D] }],
            'backdrop-invert': [{ 'backdrop-invert': ['', $, X, D] }],
            'backdrop-opacity': [{ 'backdrop-opacity': [$, X, D] }],
            'backdrop-saturate': [{ 'backdrop-saturate': [$, X, D] }],
            'backdrop-sepia': [{ 'backdrop-sepia': ['', $, X, D] }],
            ...
            duration: [{ duration: [$, 'initial', X, D] }],
            ease: [{ ease: ['linear', 'initial', h, X, D] }],
            delay: [{ delay: [$, X, D] }],
            animate: [{ animate: ['none', k, X, D] }],
            backface: [{ backface: ['hidden', 'visible'] }],
            perspective: [{ perspective: [b, X, D] }],
            ...
            'skew-x': [{ 'skew-x': eb() }],
            'skew-y': [{ 'skew-y': eb() }],
            transform: [{ transform: [X, D, '', 'none', 'gpu', 'cpu'] }],
        ...
        let r = (function (e) {
            let r = t.forwardRef((e, r) => {
              ...
              if (t.isValidElement(o)) {
                ...
                return (
                  o.type !== t.Fragment && (d.ref = r ? (0, n.t)(r, i) : i),
                  t.cloneElement(o, d)
                )
              }
